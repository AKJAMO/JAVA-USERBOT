# commands for source icss by ~ @GI53H
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 𝐒𝐨𝐮𝐫𝐜𝐞 𝐉𝐚𝐯𝐚 - 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **⌔∮ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆩 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐒𝐨𝐮𝐫𝐜𝐞 - [𝐋𝐢𝐧𝐤](t.me/GI53H)  𓆪"
            )
        else:
            await event.edit(
                "𓆰 𝐒𝐨𝐮𝐫𝐜𝐞 𝐉𝐚𝐯𝐚 - 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **⌔∮ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆩 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐒𝐨𝐮𝐫𝐜𝐞 - [𝐋𝐢𝐧𝐤](t.me/GI53H)  𓆪"
...
@bot.on(admin_cmd(pattern="رفع بنتي(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="رفع بنتي(?: |$)(.*)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="رفع ابني(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="رفع ابني(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
async def permalink(mention):
    ...
    if custom:
        await edit_or_reply(
            mention,
            f"⌔∮ المستخدم [{custom}](tg://user?id={user.id}) \n ⌔∮ تـم رفعـه مـࢪاتك طيـرو ع الـخاص يلا😏 ،",
        )
    else:
        tag = (
            user.first_name.replace("\u2060", "") if user.first_name else user.username
...
@bot.on(admin_cmd(pattern="رفع علي زبي(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="رفع علي زبي(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@bot.on(admin_cmd(pattern="رفع خول(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="رفع خول(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@bot.on(admin_cmd(pattern="رفع متناك(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="رفع متناك(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
DEV_IMG = "https://telegra.ph/file/8f59f7e12b0e1142f8458.jpg"
DEV_TEXT = "𓆩 𝑺𝒐𝒖𝒓𝒄𝒆 𝑱𝒂𝒗𝒂 - 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𓆪"
EMOJI = "  𓄂† "
...
async def _(e):
    ...
    if DEV_IMG:
        dev_c = f"**{DEV_TEXT}**\n"
        dev_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        dev_c += f"**{EMOJI}** 𝑫𝒆𝒗 𝑼𝒔𝒆𝒓 ↬ @GI53H ༗\n"
        dev_c += f"**{EMOJI}** 𝑫𝒆𝒗 𝑰𝒅 ↬ 1884453855 ༗\n"
        dev_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
