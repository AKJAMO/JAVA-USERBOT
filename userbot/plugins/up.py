...
UPSTREAM_REPO = "https://github.com/AKJAMO/JAVA-USERBOT"
...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = f"𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨 - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n** ⪼ يوجـد تحـديث جديد لسورس جافا ༗.**\n\n`{changelog}`\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆰 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @JAI6H 𓆪"
...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            await event.edit(f"{txt}\n" "بيانات اعتماد هيروكو غير صالحة لتنصيب جافا")
            return repo.__del__()
        await event.edit(
            "**تنصيب تحديث جافا قيد التقدم ، يرجى الانتظار حتى تنتهي العملية ، وعادة ما يستغرق التحديث من 4 إلى 5 دقائق.**"
        )
        ups_rem.fetch(ac_br)
...
async def upstream(event):
    "بالنسبة لأمر التحديث ، تحقق مما إذا كان بوت جافا محدثًا ، أو قم بالتحديث إذا تم بتحديثه"
